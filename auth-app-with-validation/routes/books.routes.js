...
const { capitalizeText, isValidIdFormat, isEditor, isAdmin, checkMongoooseError } = require('./../utils')
...
router.post('/crear', isLoggedIn, checkRoles('ADMIN', 'EDITOR'), (req, res) => {
    ...
    Book
        ...
        .catch(err => res.render('pages/books/new-book-form', { errorMessage: checkMongoooseError(err) }))
})
